...
import { Menu, X, Shield, BookOpen, Heart, MapPin, Settings, Moon, Sun, LogIn, LogOut, Sparkles } from 'lucide-react'; // Added Sun for light mode
...
const Navbar: React.FC = () => {
    ...
    const navLinks = [
        { name: 'Home', path: '/', icon: <Shield className="w-5 h-5" /> },
        { name: 'Journal', path: '/journal', icon: <BookOpen className="w-5 h-5" /> },
        { name: 'Affirmations', path: '/affirmations', icon: <Sparkles className="w-5 h-5" /> },
        { name: 'Resources', path: '/resources', icon: <MapPin className="w-5 h-5" /> },
        { name: 'Safety Plan', path: '/safety-plan', icon: <Heart className="w-5 h-5" /> },
        { name: 'Mood', path: '/mood', icon: <Moon className="w-5 h-5" /> },
        { name: 'Settings', path: '/settings', icon: <Settings className="w-5 h-5" /> },
            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="flex items-center p-2 rounded-md text-gray-600 hover:text-gray-900 transition-colors duration-200"
                    ...
                    <div className="md:hidden flex items-center">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-900 focus:outline-none mr-2"
                            aria-label="Toggle theme"
                        >
                            {theme === 'light' ? (
