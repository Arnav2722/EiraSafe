...
import { Shield, Mail, Lock, Eye, EyeOff, Chrome, CheckCircle, XCircle, Moon, Sun } from 'lucide-react';
          ...
          <div>
            ...
            {!isLogin && (
              <ul className="text-sm mt-2 space-y-1">
                <li className={`flex items-center ${passwordRequirements.length ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
                  {passwordRequirements.length ? <CheckCircle className="w-4 h-4 mr-2" /> : <XCircle className="w-4 h-4 mr-2" />}
                  At least 8 characters
                </li>
                <li className={`flex items-center ${passwordRequirements.uppercase ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
                  {passwordRequirements.uppercase ? <CheckCircle className="w-4 h-4 mr-2" /> : <XCircle className="w-4 h-4 mr-2" />}
                  One uppercase letter
                </li>
                <li className={`flex items-center ${passwordRequirements.lowercase ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
                  {passwordRequirements.lowercase ? <CheckCircle className="w-4 h-4 mr-2" /> : <XCircle className="w-4 h-4 mr-2" />}
                  One lowercase letter
                </li>
                <li className={`flex items-center ${passwordRequirements.digit ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
                  {passwordRequirements.digit ? <CheckCircle className="w-4 h-4 mr-2" /> : <XCircle className="w-4 h-4 mr-2" />}
                  One digit
                </li>
                <li className={`flex items-center ${passwordRequirements.specialChar ? 'text-green-600' : 'text-gray-500 dark:text-gray-400'}`}>
