...
// import { Link } from 'react-router-dom';
// import { Shield, BookOpen, Heart, MapPin, AlertTriangle, Moon, Sun } from 'lucide-react';
// import { ThemeContext } from '../contexts/ThemeContext'; // Assuming this is the path to your context file

// const HomePage: React.FC = () => {
//   const { theme, toggleTheme } = useContext(ThemeContext);

//   return (
//     <div className="space-y-10 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen transition-colors duration-500">
//       <section className="text-center mb-12">
...
//           <Link
//             to="/resources"
//             className="px-6 py-3 bg-white text-purple-700 border border-purple-200 rounded-lg shadow-sm hover:bg-purple-50 dark:bg-gray-800 dark:text-purple-400 dark:border-purple-600 transition-colors duration-300"
//           >
//             Find Resources
//           </Link>
//         </div>
...
//       {/* Safety Notice */}
//       <section className="bg-red-50 dark:bg-red-900 border border-red-100 dark:border-red-800 rounded-lg p-4 md:p-6 mb-12">
//         <div className="flex items-start">
...
//       {/* Features section */}
//       <section className="mb-12">
//         <h2 className="text-2xl font-bold text-center text-purple-800 dark:text-purple-300 mb-8">
//           How EiraSafe Supports You
//         </h2>
//         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
//           <FeatureCard 
...
//       {/* Testimonials section */}
//       <section className="mb-12 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900 dark:to-blue-900 rounded-xl p-8">
//         <h2 className="text-2xl font-bold text-center text-purple-800 dark:text-purple-300 mb-8">
//           Stories of Strength
//         </h2>
//         <div className="grid md:grid-cols-2 gap-6">
...
//       <p className="text-purple-700 dark:text-purple-400 font-medium">{author}</p>
//     </div>
//   );
// };
